...
<?php
		...
		$fe="SELECT * FROM konsumen WHERE kode_kon='$kode_kon'";
		$fg=mysql_query($fe);
		/*
		query dr perintah
		*/
  ...
  <TBODY>
    <TR>
      ...
      <TD align=middle width="100%" background="./images_tampilan/box_top_bg.gif" height=30>
	   <FONT class=option>&nbsp;&nbsp;<B>Pengisian Ulang Data Konsumen</B></FONT></TD>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
	...
	<TR>
   	  ...
   	  <TD>
			...
			<form name="form_user" action="centermenu/update_konsumen.php" method="post"> 
				...
				<td>:</td>
				<td><input type="hidden" name="kode_kon" class=field_textbox size="15" value="<?php echo"$fy[0]";?>" ></td>
				</tr>
                
                <tr><td class=centerboxtext><div align="right">Nama Konsumen </div></td>
				<td>:</td>
				<td><input type="text" name="nama_kon" class="field_textbox" size="25" value="<?php echo"$fy[1]";?>" /></td>
				</tr>
				...
				<td>
				  <label>
				    <textarea name="alamat_kon" id="textarea" cols="55" rows="3"><?php echo"$fy[2]";?></textarea>
			      </label>
				...
				<td>
				  <label>
				  <select name="kota_kon" id="select" value="<?php echo"$fy[3]";?>">
				...
				<td>:</td>
				<td><input type="text" name="telp_kon" class=field_textbox size="15" value="<?php echo"$fy[4]";?>"></td>				             
                </tr>
                
                <tr><td class=centerboxtext><div align="right">Login ID </div></td>
				<td>:</td>
				<td><input type="text" name="login_id" class=field_textbox size="25" value="<?php echo"$fy[6]";?>"></td>
				</tr>
                
                <tr><td class=centerboxtext><div align="right">Password </div></td>
				<td>:</td>
				<td><input type="password" name="password" class=field_textbox size="25" value="<?php echo"$fy[7]";?>"></td>
				</tr>
				...
				<td>:</td>
				<td><input type="text" name="email" class=field_textbox size="25" value="<?php echo"$fy[8]";?>"></td>
				</tr>
