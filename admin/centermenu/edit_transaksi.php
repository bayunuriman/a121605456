...
<script>
	function confirmDelete(oid) {
		...
		if (temp) {
			window.location='./index.php?id=hapus_transaksi&del='+oid;
		};
	};
</script>
</head>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <TR>
	   ...
	   <FONT class=option>&nbsp;&nbsp;<B>::Edit Transaksi::. </B></FONT></TD>
       	...
       	<TD>
        	<table width="100%" border="1" cellspacing="0" cellpadding="0">
                  ...
                  <tr>                                    	
					...
					<td><a href=./index.php?id=koreksi_transaksi&nota_transaksi=$data[1]>Koreksi</a></td>
					<td><a href=./index.php?id=hapus_transaksi&nota_transaksi=$data[1]>Hapus</a></td>                                      
                  </tr>
                  ";
                  }                  				  				  		
				  ?>
