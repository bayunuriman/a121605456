...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
	...
	<TR>
   	  ...
   	  <TD>
			...
			<form action="centermenu/save_supplier.php" method="post"> 
				...
				<td>:</td>
				<td><input type="text" name="kode_sup" class=field_textbox size="5"></td>
				</tr>
                
                <tr><td class=centerboxtext><div align="right">Nama Supplier </div></td>
				<td>:</td>
				<td><input type="text" name="nama_sup" class=field_textbox size="5"></td>
				</tr>
				...
				<td>
				  <label>
				    <textarea name="alamat_sup" id="textarea" cols="55" rows="3"></textarea>
			      </label>
				...
				<td>
				  <label>
				  <select name="kota_sup" id="select">
				...
				<td>:</td>
				<td><input type="text" name="telp_sup" class=field_textbox size="5"></td>
				</tr>
