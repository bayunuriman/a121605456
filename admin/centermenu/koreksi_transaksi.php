...
<body>
	...
	<?php
		...
		$fe="SELECT * FROM transaksi WHERE nota_transaksi='$nota_transaksi'";
		$fg=mysql_query($fe);
		/*
		query dr perintah
		*/
  ...
  <TBODY>
    <TR>
      ...
      <TD align=middle width="100%" background="./images_tampilan/box_top_bg.gif" height=30>
	   <FONT class=option>&nbsp;&nbsp;<B>Pengisian Ulang Transaksi</B></FONT></TD>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
	...
	<TR>
   	  ...
   	  <TD>
			...
			<form action="centermenu/update_transaksi.php" method="post"> 
				<tr><td colspan="3" class=centerboxtextheader ><center>
				  <b>Koreksi Transaksi</b>
				</center></td>
				</tr>
				<tr>
				  <td class="centerboxtext"><div align="right">Nota Transaksi</div></td>
				  <td>:</td>
				  <td><input type="hidden" name="nota_transaksi" class="field_textbox" size="10"  value="<?php echo"$fy[1]";?>"></td>
			  </tr>
				<tr>
				  <td class="centerboxtext"><div align="right">Tanggal </div></td>
				  <td>:</td>
				  <td><input type="date" name="tgl_transaksi" class="field_textbox" size="20"  value="<?php echo"$fy[2]";?>"></td>
			  </tr>
				<tr>
				  <td><div align="right">Kode Supplier</div></td>
				  <td>:</td>
				  <td class="centerboxtext"><select id="kode_sup" name="kode_sup" onchange="otomatsup(this.value)"  value="<?php echo"$fy[3]";?>">
				...
				<tr>
				  <td class="centerboxtext"><div align="right">Nama Supplier </div></td>
				  <td>:</td>
				  <td><input type="text" name="nama_sup" id="nama_sup" class="field_textbox" size="30" ></td>
			  </tr>
