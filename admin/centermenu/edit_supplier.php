...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <TR>
	   ...
	   <FONT class=option>&nbsp;&nbsp;<B>::Edit Supplier::. </B></FONT></TD>
       	...
       	<TD>
        	<table width="100%" border="1" cellspacing="0" cellpadding="0">
                  ...
                  <tr>                                    	
                    ...
                    <td>$data[4]</td>
                    <td>$data[5]</td>  
					<td><a href=./index.php?id=koreksi_supplier&kode_sup=$data[0]>Koreksi</a></td>
					<td><a href=./index.php?id=hapus_supplier&kode_sup=$data[0]>Hapus</a></td>                                      
                  </tr>
                  ";
                  }                  				  				  		
				  ?>
